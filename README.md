...
## Roadmap
- [ ] Have a working stand-alone app:
    - [ ] Adding/Saving files locally;
    - [ ] Adjust playback settings;
    - [ ] Display markdown text correctly;
    - [ ] Bluetooth remote support;
    - [ ] Available on Android Playstore;
- [ ] Have a PC controller:
    - [ ] Automatic connection over local network;
    - [ ] Ability to upload scripts to the app (txt/md files);
    - [ ] Screensaver whilst in teleprompter mode;
